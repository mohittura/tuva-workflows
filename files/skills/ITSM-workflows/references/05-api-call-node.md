...
- **Required Response Fields:** All API responses in this system must return at minimum:
...
- **When to Set:** Use for non-idempotent-safe calls only when your backend guarantees safe retries, or for read-only operations.
